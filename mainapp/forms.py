...
class feedbackForm(forms.Form):
    ...
    birth = forms.DateField(input_formats=['%d.%m.%Y'], label='Дата рождения', widget=forms.TextInput({'class' : 'u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle', 'type' : 'date'}))
